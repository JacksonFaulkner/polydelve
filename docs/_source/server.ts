// @ts-nocheck
import * as __fd_glob_12 from "../content/docs/frontend/pages.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/frontend/market-ux.mdx?collection=docs"
import * as __fd_glob_10 from "../content/docs/data/pipeline.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "backend/meta.json": __fd_glob_1, "data/meta.json": __fd_glob_2, "frontend/meta.json": __fd_glob_3, }, {"introduction.mdx": __fd_glob_4, "backend/api.mdx": __fd_glob_5, "backend/prediction-markets.mdx": __fd_glob_6, "backend/scoring.mdx": __fd_glob_7, "backend/vulnerability-tracking.mdx": __fd_glob_8, "data/local-dev.mdx": __fd_glob_9, "data/pipeline.mdx": __fd_glob_10, "frontend/market-ux.mdx": __fd_glob_11, "frontend/pages.mdx": __fd_glob_12, });